 ...
 * Wechat: queenjar
 */
public class NormalAty extends BaseDemoAty {
        ...
        mGLSurfaceView.setRenderer(new GLSurfaceView.Renderer() {
            ...
            public void onSurfaceCreated(GL10 gl, EGLConfig config) {
                ...
                mGLProgramID = ShaderHelper.getProgram(
                        AssetsHelper.getFileContent(mContext, "demo/tab/opengl/psblend/normal.vert"),
                        AssetsHelper.getFileContent(mContext, "demo/tab/opengl/psblend/normal.frag"));
            }
            ...
            public void onDrawFrame(GL10 gl) {
                ...
                GLES20.glUniform1f(uBlendStrengthHandle, 0.7f);
